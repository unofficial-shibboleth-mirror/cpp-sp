...
# ADD LINK32 log4cpp.lib libmysqld.lib saml_4.lib /nologo /dll /machine:I386 /out:"Release/shib-mysql-ccache.dll" /libpath:"..\..\..\opensaml\c\saml\Release" /libpath:"\mysql-4.0.13\lib_release"
...
# ADD LINK32 log4cppD.lib libmysqld.lib saml_4D.lib /nologo /dll /debug /machine:I386 /out:"Debug/shib-mysql-ccache.dll" /pdbtype:sept /libpath:"..\..\..\opensaml\c\saml\Debug" /libpath:"\mysql-4.0.13\lib_debug"
