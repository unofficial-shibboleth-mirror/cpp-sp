...
# ADD LINK32 log4cppD.lib saml.lib libmysqld.lib /nologo /dll /machine:I386 /libpath:"..\..\..\opensaml\c\saml\Release" /libpath:"\mysql\Embedded\DLL\release"
...
# ADD LINK32 log4cppD.lib saml.lib libmysqld.lib /nologo /dll /debug /machine:I386 /pdbtype:sept /libpath:"..\..\..\opensaml\c\saml\Debug" /libpath:"\mysql\Embedded\DLL\debug"
